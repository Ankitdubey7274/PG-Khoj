...
public class Delhi extends JFrame implements ActionListener{
    ...
    Delhi(){
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg/4.jpg"));
        ...
        JLabel text = new JLabel("PG For Girls In Chhatra Marg");
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/3.jpg"));
        ...
        JLabel text2 = new JLabel("PG For Boys in Pal House");
        text2.setBounds(500, 330, 150, 100 );
        text2.setForeground(Color.black);
        text2.setFont(new Font("serif",Font.BOLD, 20));
        add(text2);

        JLabel addr2 = new JLabel("Rajpura pal chowk near Delhi University");
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/5.jpg"));
