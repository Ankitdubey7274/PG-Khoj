...
public class Mumbai extends JFrame implements ActionListener{
    ...
    Mumbai(){
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg/6.jpg"));
        ...
        JLabel text = new JLabel("PG For Girls In Gachibowli");
        text.setBounds(100, 330, 150, 100 );
        text.setForeground(Color.black);
        text.setFont(new Font("serif",Font.BOLD, 20));
        add(text);

        JLabel addr1 = new JLabel("Anjaiah Nagar near Bhadrakali Temple, Gachibowli,Mumbai");
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/7.jpg"));
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/8.jpg"));
