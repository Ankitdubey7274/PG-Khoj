...
public class Pune extends JFrame implements ActionListener{
    ...
    Pune(){
        ...
        JMenu mum = new JMenu("PG IN PUNE");
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg\\bed.jpg.jpg"));
        ...
        JLabel text = new JLabel("PG For Girls In Pimpri");
        text.setBounds(100, 300, 150, 100 );
        text.setForeground(Color.black);
        text.setFont(new Font("serif",Font.BOLD, 20));
        add(text);

        JLabel addr1 = new JLabel(" H R Mahajani Rd, Pimpri Gao, pune, Maharashtra");
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/2.jpg"));
        ...
        JLabel text2 = new JLabel("PG For Boys In Bhoomi Plaza");
        text2.setBounds(500, 300, 150, 100 );
        text2.setForeground(Color.black);
        text2.setFont(new Font("serif",Font.BOLD, 20));
        add(text2);

        JLabel addr2 = new JLabel("Sant Tukaram Nagar,pimpri,pune");
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/1.jpg"));
        ...
        JLabel text3 = new JLabel("PG For Boys In Bhoomi Plaza");
        text3.setBounds(900, 300, 150, 100 );
        text3.setForeground(Color.black);
        text3.setFont(new Font("serif",Font.BOLD, 20));
        add(text3);

        JLabel addr3 = new JLabel("Ankit Lodge Near Dyp ,pimpri ,pune");
