...
public class Ranchi extends JFrame implements ActionListener{

    JButton back,  contact1, contact2, contact3;

    Ranchi(){
        setLayout(null);
        setTitle("PG in Ranchi");
        setSize(1400, 640);
        setLocation(100,100);
        ...
        JMenu mum = new JMenu("PG IN Ranchi");
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg/9.jpg"));
        ...
        JLabel text = new JLabel("Private Room for Girls");
        text.setBounds(100, 330, 150, 100 );
        text.setForeground(Color.black);
        text.setFont(new Font("serif",Font.BOLD, 20));
        add(text);

        JLabel addr1 = new JLabel("in Vijay Lakshmi Apartments, Dum Dum, Ranchi North, Ranchi");
        addr1.setBounds(100, 360, 400, 100 );
        addr1.setForeground(Color.gray);
        addr1.setFont(new Font("serif",Font.PLAIN, 20));
        add(addr1);

        JLabel rent1 = new JLabel("₹ 7000 per month onwards");
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/10.jpg"));
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/11.jpg"));
